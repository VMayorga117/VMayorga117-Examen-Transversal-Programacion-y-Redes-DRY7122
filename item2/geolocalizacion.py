...
API_KEY = "62103c1e-fb53-480d-8857-0d9d4fee6bdc"
...
def calcular_ruta(origen, destino, medio):
    ...
    print(f"Distancia total: {distancia_km:.2f} km / {distancia_mi:.2f} mi")
...
print("Puede salir en cualquier momento escribiendo 's'.\n")
...
while True:
    ...
    if medio not in ["car", "bike", "foot"]:
        print("⚠ Medio de transporte no válido. Intente con: car, bike o foot.\n")
        continue

    calcular_ruta(origen, destino, medio)

print("Gracias por utilizar el sistema de rutas.")
